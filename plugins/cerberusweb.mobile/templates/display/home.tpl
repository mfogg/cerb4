<div id="top_nav">
	<img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/c4_logo_20.gif{/devblocks_url}" align="top">
...
<div id="toolbar">
	...
	<div id="tb_display" class="tb">
		<a href="javascript:none();" id="tb_btn_back_display2"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/arrow_left_green.png{/devblocks_url}" align="top"></a>		
		<a href="javascript:none();" id="tb_btn_close" class="tb_prop_link"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/folder_ok.png{/devblocks_url}" align="top"></a>
		<a href="javascript:none();" id="tb_btn_spam" class="tb_prop_link"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/spam.png{/devblocks_url}" align="top"></a>
		<a href="javascript:none();" id="tb_btn_delete" class="tb_prop_link"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/delete.png{/devblocks_url}" align="top"></a>
		<a href="javascript:none();" id="tb_btn_take" class="tb_prop_link"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/hand_paper.png{/devblocks_url}" align="top"></a>
	</div>	

	<div id="tb_display_right" class="tb tb_right">
		<a href="javascript:none();" id="tb_btn_reply_display"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/export2.png{/devblocks_url}" align="top"></a>		
	</div>


	<div id="tb_reply" class="tb">
		<a href="javascript:none();" id="tb_btn_back_display"><img src="{devblocks_url}c=resource&p=cerberusweb.mobile&f=images/24x24/arrow_left_green.png{/devblocks_url}" align="top"></a>		
	</div>
